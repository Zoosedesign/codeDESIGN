...
$(document).ready(function() {
    $('body').on('click', '[name="checkout"], [name="goto_pp"], [name="goto_gc"]', function() {
      if ($('#agree').is(':checked')) {
        ...
        alert("Dovete accettare prima i 'Termini e condizioni di vendita' e l'Informativa Privacy'.");
        return false;
      }
    });
  });

//eliminate double tap
(function() {
    $(document).ready(function() {
        if (iOS()) {
            ...
            $('body').on("click", ".cpb-option.cpb-option-type-text", function() {
                setTimeout(function() {
                    removeTooltips();
                }, 300);
            });

            $('body').on("click", ".react-tabs__tab", function() {
                setTimeout(function() {
                    removeTooltips();
                }, 300);
            });
    ...
    function removeTooltips() {
        ...
        for (var i = 1; i < 200; i++) {
            currentTooltip = $(tooltipSelector + i)[0];
            if (currentTooltip) {
                $(tooltipSelector + i).remove();
            }
        }
    }
